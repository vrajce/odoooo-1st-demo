...
const mockBookings: BookingData[] = [
  {
    ...
    amount: 1000,
    status: 'confirmed',
    playerAvatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face'
  },
  {
    id: '2',
    ...
    amount: 500,
    status: 'pending',
    playerAvatar: 'https://images.unsplash.com/photo-1494790108755-2616b612c47d?w=40&h=40&fit=crop&crop=face'
  },
  {
    id: '3',
    ...
    amount: 1500,
    status: 'completed',
    playerAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=40&h=40&fit=crop&crop=face'
  }
];
...
const mockCourts: CourtData[] = [
  {
    ...
    sport: 'Basketball',
    image: 'https://images.unsplash.com/photo-1544944194-b447c5c04315?w=200&h=150&fit=crop&crop=center',
    totalBookings: 47,
    revenue: 23500,
    rating: 4.8,
    isActive: true,
  ...
  },
  {
    ...
    sport: 'Football',
    image: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=200&h=150&fit=crop&crop=center',
    totalBookings: 28,
    revenue: 42000,
    rating: 4.6,
    isActive: false,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/owner-profile" className="text-gray-700 hover:text-atlantis-500 transition-colors">Profile</Link>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Welcome back, Elite Sports Arena!</h1>
              <p className="text-gray-600 mt-1">Here's what's happening with your courts today</p>
            </div>
        ...
        <div className="bg-white rounded-t-2xl shadow-lg border border-gray-100 mt-6">
          ...
          <div className="p-6">
                  ...
                  <div className="bg-gradient-to-r from-atlantis-500 to-apple-600 rounded-2xl p-6 text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-atlantis-200">+12% from last week</p>
                      </div>
                  ...
                  <div className="bg-gradient-to-r from-feijoa-500 to-feijoa-600 rounded-2xl p-6 text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-feijoa-200">+8% from last week</p>
                      </div>
                  ...
                  <div className="bg-gradient-to-r from-energy-400 to-energy-500 rounded-2xl p-6 text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-energy-200">Today's confirmed</p>
                      </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-6 text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-purple-200">Out of {mockCourts.length} total</p>
                      </div>
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                      {mockBookings.slice(0, 3).map((booking) => (
                        <div key={booking.id} className="flex items-center justify-between p-4 bg-white rounded-xl">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">{booking.sport} • {formatDate(booking.date)}</p>
                            </div>
                          </div>
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                      {mockCourts.map((court) => (
                        <div key={court.id} className="flex items-center justify-between p-4 bg-white rounded-xl">
                          <div className="flex items-center space-x-3">
                            <img 
                              src={court.image} 
                              alt={court.name}
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm text-gray-500">• {court.totalBookings} bookings</span>
                              </div>
                            </div>
                          </div>
                          <div className="text-right">
                            <p className="font-semibold text-gray-900">₹{court.revenue.toLocaleString()}</p>
                            <div className={`w-2 h-2 rounded-full ${court.isActive ? 'bg-feijoa-500' : 'bg-gray-400'} ml-auto mt-1`}></div>
                          </div>
                        </div>
                      ))}
                    </div>
                          ...
                          <tr key={booking.id} className="hover:bg-gray-50">
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                ...
                                />
                                <span className="text-sm font-medium text-gray-900">{booking.playerName}</span>
                              </div>
                            </td>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{booking.duration}h</td>
            ...
            {activeTab === 'courts' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-gray-900">My Courts</h3>
                  <Link
                    to="/add-court"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {mockCourts.map((court) => (
                    <div key={court.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover-lift">
                      <div className="relative">
                        ...
                        <div className="absolute top-3 right-3 flex space-x-2">
                          <div className={`w-3 h-3 rounded-full ${court.isActive ? 'bg-feijoa-500' : 'bg-red-500'}`}></div>
                      ...
                      <div className="p-6">
                        ...
                        <div className="space-y-2 mb-4">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">{court.totalBookings}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Revenue:</span>
                            <span className="font-medium">₹{court.revenue.toLocaleString()}</span>
                          </div>
                          {court.nextBooking && (
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-600">Next Booking:</span>
                              <span className="font-medium text-feijoa-600">{court.nextBooking}</span>
                            </div>
                          )}
                        </div>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <div className="w-full h-64 bg-gradient-to-br from-sahara-100 to-feijoa-100 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-300">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-400">Shows daily/weekly/monthly revenue</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <div className="w-full h-64 bg-gradient-to-br from-atlantis-100 to-feijoa-100 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-300">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500">Booking trends and patterns</p>
                        <p className="text-sm text-gray-400">Peak hours and popular sports</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-gray-50 rounded-xl">
                      <p className="text-2xl font-bold text-atlantis-500">84%</p>
