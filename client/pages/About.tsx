...
const teamMembers = [
  ...
  },
  {
    ...
    role: "CTO",
    image:
      "https://images.unsplash.com/photo-1494790108755-2616b612c47d?w=300&h=300&fit=crop&crop=face",
...
const values = [
  {
    ...
    description:
      "Building strong connections between sports enthusiasts and creating lasting friendships through shared passion.",
  },
  {
    icon: Star,
    title: "Excellence",
    description:
      "Maintaining the highest standards in court quality, service delivery, and user experience.",
  },
  {
    icon: Heart,
    title: "Inclusivity",
    description:
      "Creating welcoming spaces for players of all skill levels, backgrounds, and abilities.",
  },
  {
    icon: Zap,
    title: "Innovation",
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-6">
                ...
                <Link to="/about" className="text-atlantis-500 font-medium">
                  About
                </Link>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Link
                to="/signup"
                className="px-6 py-2 bg-gradient-atlantis text-white rounded-xl font-medium hover:shadow-atlantis-glow transition-all duration-300"
              >
                Sign Up
              </Link>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8">
              We're building the world's largest platform for sports enthusiasts
              to discover courts, organize matches, and build lasting
              connections through the power of play.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-atlantis-500 mb-2">
                  {stat.value}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                QuickCourt was born from a simple belief: sports should bring
                people together, not divide them. We noticed that finding
                quality courts and like-minded players was often a challenge,
                especially in growing urban areas.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                Our platform removes these barriers by creating a seamless
                experience for players to discover courts, connect with fellow
                athletes, and organize matches that fit their schedule and skill
                level.
              </p>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Make sports accessible to everyone, everywhere
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We're a diverse group of sports enthusiasts, tech innovators, and
              community builders working together to transform how people
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <p className="text-atlantis-600 font-medium mb-3">
                  {member.role}
                </p>
          ...
          <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    QuickCourt started as a weekend project when our founder
                    Alex couldn't find a decent basketball court for a pickup
                    game. Frustrated by the lack of organized sports options in
                    urban areas, he decided to build a solution.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-energy-50 to-sahara-50 rounded-2xl p-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    As the platform gained traction, we brought together a
                    passionate team of developers, designers, and sports
                    enthusiasts. We expanded from basketball to multiple sports
                    and launched in 5 major cities.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-atlantis-50 to-feijoa-50 rounded-2xl p-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    2024 - National Expansion
                  </h3>
                  <p className="text-gray-700">
                    Today, QuickCourt connects thousands of players across 25+
                    cities. We've facilitated over 100,000 matches and continue
                    to grow our community of sports enthusiasts who believe in
                    the power of play.
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 bg-gradient-to-r from-atlantis-500 to-apple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-atlantis-100 mb-8">
            Whether you're a player looking for your next match or a court owner
            wanting to reach more athletes, QuickCourt is here for you.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/signup"
