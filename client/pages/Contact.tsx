  ...
  const faqs = [
    {
      ...
      answer:
        "Simply browse available courts, select your preferred date and time, and complete the booking process. You'll receive instant confirmation.",
    },
    {
      question: "Can I cancel my booking?",
      answer:
        "Yes, you can cancel bookings up to 2 hours before the scheduled time for a full refund. Cancellations within 2 hours are subject to a cancellation fee.",
    },
    {
      question: "How do I list my court on QuickCourt?",
      answer:
        "Click 'List Your Court' and complete our owner onboarding process. We'll verify your facility and help you get started within 48 hours.",
    },
    {
      question: "Is my payment information secure?",
      answer:
        "Absolutely. We use industry-standard encryption and work with trusted payment partners to ensure your financial information is completely secure.",
    },
  ];
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-6">
                ...
                <Link to="/contact" className="text-atlantis-500 font-medium">
                  Contact
                </Link>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Have questions, suggestions, or need support? We're here to help and
                  ...
                  return (
                    <div key={index} className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-atlantis-600 font-medium mb-1">
                          {info.details}
                        </p>
