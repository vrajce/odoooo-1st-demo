  ...
  const handleArrayToggle = (field: string, value: string) => {
    setFormData((prev) => ({
      ...
      [field]: prev[field as keyof OnboardingData].includes(value)
        ? (prev[field as keyof OnboardingData] as string[]).filter(
            (item) => item !== value,
          )
  ...
  const isStepComplete = (step: number) => {
    switch (step) {
      ...
      case 2:
        return (
          formData.courtName &&
          formData.courtType.length > 0 &&
          formData.capacity > 0
        );
      case 3:
        return (
          Object.values(formData.documents).some((doc) => doc !== null) &&
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            List your sports facility and start earning with QuickCourt
          </p>
        </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div
                      key={doc.key}
                      className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-atlantis-400 transition-colors"
                    >
              ...
              <div className="bg-sahara-50 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm text-gray-600">
                      <p>
                        <strong>Name:</strong> {formData.courtName}
                      </p>
                      <p>
                        <strong>Sports:</strong> {formData.courtType.join(", ")}
                      </p>
                      <p>
                        <strong>Capacity:</strong> {formData.capacity} players
                      </p>
                      <p>
                        <strong>Price:</strong> ₹{formData.pricePerHour}/hour
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-energy-50 rounded-lg">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-energy-800">
                        Verification Process
                      </h4>
                      <p className="text-sm text-energy-700 mt-1">
                        Your application will be reviewed within 24-48 hours.
                        You'll receive an email confirmation once approved. Our
                        team may contact you if additional information is
                        required.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <label className="flex items-start space-x-3">
                    <input
                      type="checkbox"
                      className="mt-1 w-4 h-4 text-atlantis-600 border-gray-300 rounded focus:ring-atlantis-500"
                      required
                    />
                    <span>
                      I agree to QuickCourt's Terms of Service and Privacy
                      Policy
                    </span>
                  </label>
                  <label className="flex items-start space-x-3">
