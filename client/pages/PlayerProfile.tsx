  ...
  const tabs = [
    {
      ...
      count: mockBookings.active.length,
    },
    { id: "past", label: "Past Bookings", count: mockBookings.past.length },
    {
      id: "cancelled",
      label: "Cancelled",
      count: mockBookings.cancelled.length,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/profile" className="text-atlantis-500 font-medium">
                Profile
              </Link>
            ...
            {mockBookings[activeTab].length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  {activeTab === "active" &&
                    "You don't have any active bookings. Book a court to get started!"}
                  {activeTab === "past" &&
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <span
                              className={`flex items-center space-x-1 px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(booking.status)}`}
                            >
                            ...
                            <span className="text-sm font-semibold text-energy-600">
                              ₹{booking.price}
                            </span>
                          </div>
                        </div>
                          ...
                          <div className="absolute right-0 top-full mt-1 w-48 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-10">
                            {booking.status === "confirmed" && (
                              <>
                                <button
                                  onClick={() =>
                                    handleAction("reschedule", booking.id)
                                  }
                            ...
                            {booking.status === "completed" && (
                              <>
                                <button
                                  onClick={() =>
                                    handleAction("review", booking.id)
                                  }
                                  className="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 transition-colors"
                                >
                                  Leave Review
                                ...
                                <button
                                  onClick={() =>
                                    handleAction("rebook", booking.id)
                                  }
