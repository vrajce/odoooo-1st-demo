...
const mockMatch: MatchDetail = {
  ...
  description:
    "Competitive basketball match for intermediate level players. We focus on team play and sportsmanship. Looking for skilled players who can commit to the full match duration. This will be a great opportunity to showcase your skills and meet fellow basketball enthusiasts.",
  status: "open",
  organizer: {
    id: "org1",
    name: "Alex Rodriguez",
  ...
  players: [
    ...
    },
    {
      ...
      name: "Sarah Wilson",
      avatar:
        "https://images.unsplash.com/photo-1494790108755-2616b612c47d?w=50&h=50&fit=crop&crop=face",
      rating: 4.9,
      skillLevel: "Advanced",
      joinedDate: "2022",
    },
...
export default function MatchDetails() {
  ...
  const handleJoinRequest = async () => {
    ...
    setTimeout(() => {
      ...
      alert(
        `Join request sent to ${match.organizer.name}! You'll be notified when they respond.`,
      );
    }, 2000);
  };
  ...
  const getSkillColor = (skill: string) => {
    switch (skill) {
      ...
      case "Intermediate":
        return "bg-energy-100 text-energy-700";
      case "Advanced":
        return "bg-atlantis-100 text-atlantis-700";
      case "Expert":
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span
                      className={`px-3 py-1 text-sm font-medium rounded-full ${getStatusColor(match.status)}`}
                    >
                      {match.status === "open"
                        ? "Open"
                        : match.status === "almost-full"
                          ? "Almost Full"
                          : match.status}
                    </span>
                    {match.isPrivate && (
                  ...
                  <div className="flex items-center space-x-4 text-gray-600 mb-4">
                    ...
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${getSkillColor(match.skillLevel)}`}
                    >
                      {match.skillLevel}
                    </span>
                  </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      {formatTime(match.time)} ({match.duration}h)
                    </div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600">
                    {match.organizer.totalMatches} matches organized • Member
                    since {match.organizer.joinedDate}
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {match.players
                  .slice(0, showAllPlayers ? undefined : 6)
                  .map((player) => (
                    <div
                      key={player.id}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span
                          className={`inline-block px-2 py-0.5 text-xs font-medium rounded-full ${getSkillColor(player.skillLevel)}`}
                        >
                          {player.skillLevel}
                        </span>
                      </div>
                ...
                {Array.from({ length: spotsLeft }, (_, index) => (
                  <div
                    key={`empty-${index}`}
                    className="flex items-center justify-center p-3 border-2 border-dashed border-gray-300 rounded-xl"
                  >
                  ...
                  showAllPlayers
                    ? undefined
                    : Math.max(0, 6 - match.currentPlayers),
                )}
              </div>
              ...
              {match.players.length > 6 && (
                ...
                >
                  {showAllPlayers
                    ? "Show Less"
                    : `Show All ${match.players.length} Players`}
                </button>
              )}
            </div>
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                <div className="text-center mb-6">
                  <div className="text-2xl font-bold text-atlantis-500 mb-1">
                    {match.price}
                  </div>
                ...
                {match.status === "full" ? (
                  <div className="text-center py-4">
                    ...
                    <p className="text-sm text-gray-600">
                      This match has reached capacity
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    {spotsLeft <= 3 && spotsLeft > 0 && (
                      <div className="flex items-center space-x-2 text-energy-600 text-sm mb-4">
                        ...
                        <span>
                          Only {spotsLeft} spot{spotsLeft !== 1 ? "s" : ""}{" "}
                          left!
                        </span>
                      </div>
                    )}
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span
                      className={`px-2 py-0.5 text-xs font-medium rounded-full ${getSkillColor(match.skillLevel)}`}
                    >
                      {match.skillLevel}
                    </span>
                  </div>
              ...
              <div className="bg-feijoa-50 rounded-2xl p-6 border border-feijoa-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-feijoa-800 mb-2">
                      Safety First
                    </h4>
                    <p className="text-sm text-feijoa-700">
                      All matches are monitored for safety. Report any issues to
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-8 shadow-2xl border border-feijoa-200 shadow-feijoa-glow/30">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Send a request to join "{match.title}"
              </p>
            </div>
            ...
            <div className="bg-sahara-50 rounded-xl p-4 mb-6">
              ...
              <div className="text-sm text-gray-600">
                <p>
                  <strong>Match:</strong> {match.title}
                </p>
                <p>
                  <strong>Date:</strong> {formatDate(match.date)} at{" "}
                  {formatTime(match.time)}
                </p>
                <p>
                  <strong>Cost:</strong> {match.price}
                </p>
              </div>
            </div>
