...
import { Search, MapPin, Clock, Users, Star, ChevronRight, Calendar, Trophy, Play } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sahara-100 via-sahara-50 to-feijoa-50">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className={`relative z-10 text-center text-white max-w-4xl mx-auto px-4 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-2xl mx-auto">
            Connect with players, book courts, and join the ultimate sports community experience
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover top-rated sports facilities with premium amenities and flexible booking options
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center text-gray-600 mb-3">
                  ...
                  <span className="text-sm">{court.location} • {court.distance}</span>
                </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Find players looking for teammates and jump into exciting games happening near you
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <span className="text-sm">Organized by {match.organizer}</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link to="/create-match" className="hover:text-atlantis-400 transition-colors">Create Match</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link to="/owner-dashboard" className="hover:text-atlantis-400 transition-colors">Owner Dashboard</Link></li>
