...
const mockPlayers: Player[] = [
  ...
  },
  {
    ...
    name: "Sarah Chen",
    avatar:
      "https://images.unsplash.com/photo-1494790108755-2616b612c47d?w=150&h=150&fit=crop&crop=face",
...
const mockGroups: Group[] = [
  {
    ...
    description:
      "Competitive basketball league for advanced players in the downtown area.",
    memberCount: 24,
    sport: "Basketball",
    image:
      "https://images.unsplash.com/photo-1544944194-b447c5c04315?w=300&h=200&fit=crop&crop=center",
    isPrivate: false,
  ...
  },
  {
    ...
    description:
      "A friendly community for tennis players of all skill levels to meet and play.",
    memberCount: 18,
    sport: "Tennis",
    image:
  ...
  },
  {
    ...
    description:
      "Football group for weekend matches and friendly competitions.",
    memberCount: 31,
    sport: "Football",
    image:
      "https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=300&h=200&fit=crop&crop=center",
    isPrivate: false,
  ...
  },
  {
    ...
    sport: "Mixed",
    image:
      "https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?w=300&h=200&fit=crop&crop=center",
    isPrivate: true,
...
export default function Community() {
  ...
  const filteredPlayers = mockPlayers.filter((player) => {
    ...
    const matchesSport =
      !sportFilter || player.favoritesSports.includes(sportFilter);
  ...
  const filteredGroups = mockGroups.filter((group) => {
    ...
    const matchesSport =
      !sportFilter || group.sport === sportFilter || group.sport === "Mixed";
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-6">
                ...
                <Link to="/community" className="text-atlantis-500 font-medium">
                  Community
                </Link>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Connect with players, join groups, and build your sports
                  network
                </p>
              </div>
            </div>
                    ...
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                          ...
                          <span
                            className={`px-2 py-0.5 text-xs font-medium rounded-full ${getSkillColor(player.skillLevel)}`}
                          >
                            {player.skillLevel}
                          </span>
                        </div>
